...
3. **Modelo de LLM para responder**: `gpt-5-nano`

## Gemini

1. Crie uma API Key da Google.
2. **Modelo de embeddings**: `models/embedding-001`
3. **Modelo de LLM para responder**: `gemini-2.5-flash-lite`
...
Faça um fork do repositório para utilizar a estrutura abaixo: [Clique aqui](https://github.com/exemplo)
...
- [Curso de nivelamento com LangChain](https://github.com/exemplo)
- [Template básico com estrutura do projeto](https://github.com/exemplo)
- [VirtualEnv para Python](https://docs.python.org/3/library/venv.html)
